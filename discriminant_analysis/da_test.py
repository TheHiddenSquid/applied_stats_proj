    ...
    for i in range(no_tests):
        ...
        for j in range(num_folds):
            ...
            for point in testing:
                guess = classify(point[:-1], liked_rv, disliked_rv)
                correct = point[-1]
...
def main():
    ...
    ans = test_methods_cv(dataset, no_tests=10, num_folds=5, method="QDA")
    print("QDA:", ans)
